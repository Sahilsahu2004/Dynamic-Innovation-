...
export default function Footer() {
  return (
    <footer className="bg-forest pt-20">
        ...
        <div className="grid gap-12 border-t border-cream/10 py-14 sm:grid-cols-2 lg:grid-cols-4">
              ...
              {LINKS.map((l) => (
                <li key={l.href}>
                  <motion.a
                    whileHover={{ x: 4 }}
                    href={l.href}
                    className="inline-block text-[13.5px] text-cream/55 hover:text-lime transition-colors"
                  >
                    {l.label}
                  </motion.a>
                </li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-[13.5px] text-cream/55">
              ...
              <li><a href="https://wa.me/917009550413" className="hover:text-lime transition-colors">+91 70095 50413</a></li>
              <li><a href="mailto:info@dynainnovate.com" className="hover:text-lime transition-colors">info@dynainnovate.com</a></li>
