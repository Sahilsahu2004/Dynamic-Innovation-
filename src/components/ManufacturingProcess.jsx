...
export default function ManufacturingProcess() {
  return (
    <section id="process" className="bg-forest py-24 md:py-28">
          ...
          {STEPS.map((s, i) => (
            ...
            >
              <motion.span
                ...
                className="font-display text-[15px] font-extrabold text-lime"
              >
                {s.n}
              </motion.span>
              ...
              {i < STEPS.length - 1 && (
                <span className="absolute -right-3 top-1/2 hidden -translate-y-1/2 text-lime/50 lg:block">
                  →
                </span>
              )}
            </motion.div>
