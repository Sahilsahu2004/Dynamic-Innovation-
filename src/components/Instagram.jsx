    ...
    <section className="bg-cream py-24 md:py-28">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <h2 className="font-head font-bold text-[26px] leading-tight text-forest sm:text-[32px]">
          ...
          <motion.a
            ...
            className="flex items-center gap-2 text-[14px] font-semibold text-forest"
          >
            @dynamicinnovations ↗
          </motion.a>
        </div>
