    ...
    <section id="custom" className="bg-cream py-24 md:py-28">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <h2 className="font-head font-bold text-[28px] leading-tight text-charcoal sm:text-[34px]">
          <RevealText text="Why " />
          <span className="text-lime-deep"><RevealText text="Dynamic Innovations" delay={0.1} /></span>
        </h2>
        ...
        <div className="mt-14 grid gap-x-12 gap-y-10 sm:grid-cols-2">
          {REASONS.map((r, i) => (
            <motion.div
              ...
              whileHover={{ x: 6 }}
              className="flex gap-4 border-l-2 border-lime pl-5"
            >
              <motion.span
              ...
              <div>
                <h3 className="font-head text-[16px] font-bold text-forest">{r.title}</h3>
