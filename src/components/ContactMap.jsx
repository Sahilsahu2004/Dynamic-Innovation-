...
export default function ContactMap() {
  return (
    <section id="contact" className="bg-forest py-24 md:py-28">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          >
            ...
            <div>
              ...
              <a href="https://wa.me/917009550413" className="mt-1 block text-cream/60 hover:text-lime transition-colors">
                +91 70095 50413
              </a>
            </div>
            <div>
              <p className="font-head font-semibold text-cream">Email</p>
              <a href="mailto:info@dynainnovate.com" className="mt-1 block text-cream/60 hover:text-lime transition-colors">
