...
const inputCls =
  'w-full border-b border-cream/25 bg-transparent py-3 text-[15px] text-cream placeholder:text-cream/40 focus:border-lime focus-ring outline-none transition-colors'
...
export default function EnquiryForm() {
  ...
  return (
    <section id="enquiry" className="bg-forest py-24 md:py-32">
      <div className="mx-auto grid max-w-7xl gap-16 px-6 md:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
        <div>
          ...
          <div className="mt-10 space-y-4 text-[14px] text-cream/70">
            <div>
              <p className="font-head text-[11px] font-bold uppercase tracking-wide text-lime">Contact Person</p>
              <p className="mt-1">Rahul Agrawal — CEO</p>
            </div>
            <div>
              <p className="font-head text-[11px] font-bold uppercase tracking-wide text-lime">Phone / WhatsApp</p>
              <a href="https://wa.me/917009550413" className="mt-1 block hover:text-lime transition-colors">+91 70095 50413</a>
            </div>
            <div>
              <p className="font-head text-[11px] font-bold uppercase tracking-wide text-lime">Email</p>
              <a href="mailto:info@dynainnovate.com" className="mt-1 block hover:text-lime transition-colors">info@dynainnovate.com</a>
            </div>
            <div>
              <p className="font-head text-[11px] font-bold uppercase tracking-wide text-lime">Address</p>
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            {sent ? (
              ...
              >
                <span className="grid h-14 w-14 place-items-center bg-lime text-forest text-2xl">
                  ✓
                </span>
              ...
              >
                ...
                >
                  {PRODUCTS.map((p) => (
                    <option key={p} value={p} className="bg-forest text-cream">
                      {p}
                    </option>
                  ))}
                </motion.select>
                ...
                <motion.button
                  ...
                  type="submit"
                  className="mt-2 flex w-fit items-center gap-2 bg-lime px-8 py-3.5 text-[14px] font-semibold text-forest-deep sm:col-span-2"
                >
                  Send enquiry
                </motion.button>
              </motion.form>
